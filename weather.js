...
(function () {
  ...
  // Contador animado de temperatura (0 -> valor)
  ...
  function renderizar(dados) {
    ...
    for (var i = 0; i < d.time.length && i < 5; i++) {
      ...
      item.innerHTML =
        "<span class=\"weather-panel__icone " + info[2] + "\" aria-hidden=\"true\">" + info[0] +
          "<span class=\"clima-flash\"></span>" +
        "</span>" +
        "<span class=\"weather-panel__info\">" +
        "<span class=\"weather-panel__nome\">" + nomeDia(d.time[i], hojeIso) + "</span>" +
        "<span class=\"weather-panel__temp\"><strong data-alvo=\"" + max + "\">0°</strong> " +
          "<span data-alvo=\"" + min + "\">0°</span></span>" +
        "</span>";
      ...
      (function (el, mx, mn, delay) {
        ...
        setTimeout(function () {
          var strong = el.querySelector(".weather-panel__temp strong");
          var span = el.querySelector(".weather-panel__temp span");
          if (strong) animarNumero(strong, mx);
          if (span) animarNumero(span, mn);
        }, delay + 250);
      })(item, max, min, i * 100);
    }
  ...
  function injetarCSSAnimacao() {
    ...
    style.textContent = `
      ...
      /* Brilho pulsante ao redor de cada dia, na cor do clima */
      ...
      /* Destaque especial no dia de HOJE */
      ...
      /* Flash de raio para tempestades */
      .clima-flash {
